    ...
    <div className="w-screen h-screen bg-white overflow-hidden font-[Dosis] relative">
      <div className="flex items-center justify-center h-full">
        <div className="bg-white rounded-[6px] p-16 shadow-sm border border-gray-300 w-[650px]">
          ...
          {/* New Password */}
          <div className="mb-6">
            <label className="block text-lm font-dosis font-medium text-gray-700">
              New Password
            </label>
            <div className="relative">
              ...
              <input
                ...
                className="w-full h-12 pl-10 pr-12 border font-dosis border-gray-300 rounded-lg focus:outline-none"
              />
              <button
                type="button"
          ...
          <div className="mb-8">
            ...
            <div className="relative">
              ...
              <input
                ...
                className="w-full h-12 pl-10 pr-12 font-dosis border border-gray-300 rounded-lg focus:outline-none"
              />
              <button
                type="button"
          ...
          <div className="flex justify-center">
            <button
              ...
              className="w-[300px] h-12 bg-[#4B2E2E] font-dosis text-white rounded-lg text-lg font-medium hover:bg-[#2D2623] transition-colors mb-6"
            >
              Reset Password
            </button>
          </div>
